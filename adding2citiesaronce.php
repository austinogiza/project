...
<form method="POST" action="processes/add2cities_process.php" id="form1">
		<label>
...
<label>
 ...
 {
 	for($a=0;$a<count($_SESSION['city_name[]']);$a++)
     {
	?>
...
<?php
	...
	?>
	<div id="here" style="margin-bottom: 5px;"></div>
<div>
		<input type="button" value="Add More Cities" id="addcity" style="margin-bottom: 10px;">
		</div>
...
<script>
	...
	$(document).ready(()=>{
		...
		$("#addcity").click(()=>{
			...
			$("#here").append("<label><div class='regis'>City Name:<input type='text' name='city_name[]'  id='city_name' placeholder='City Name'></div></label>");
		});
	});
</script>
