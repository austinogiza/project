...
if (isset($_POST['cities_id']) && trim($_POST['cities_id'])!= "" )
{
$cities_id=$_POST['cities_id'];
$cities_id_SESSION['cities_id']= $cities_id;
...
//save user details to database
	...
	mysqli_query($connection, 
		...
		phone= '$phone', email='$email', password='$password', username= '$username',  role_id='$role_id', state_id='$state_id', cities_id='$cities_id', admin='$admin'"
